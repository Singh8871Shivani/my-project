...
const Footer = () => {
  return (
    <footer className="bg-[#5f1515] text-white py-10">
      <div className="px-4">
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-center">
          <p className="text-sm">
            &copy; 2022 Your Company LLC. <a href="/" className="hover:underline">Yuna Theme</a> by <a href="/" className="hover:underline">SSVR Design</a>.
          </p>
        </div>
      </div>
    </footer>
